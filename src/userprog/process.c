...
void load_argument_into_stack (void **esp, int argc, int argv[]);
...
process_execute (const char *file_name) 
{
  ...
  /* Sema down the parent process and wait children process */
...
void
load_argument_into_stack (void **esp, int argc, int argv[]){
